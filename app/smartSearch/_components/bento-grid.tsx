  ...
  return (
    ...
    >
        ...
        <div className="flex justify-between">
          <button onClick={() => summarize({description})} className="px-4 py-2 rounded-xl bg-black dark:bg-white dark:text-black hover:bg-white hover:text-black border hover:border-black text-white text-xs font-bold">
            Summarize
          </button>
          <button className="px-4 py-2 rounded-xl bg-black dark:bg-white dark:text-black hover:bg-white hover:text-black border hover:border-black text-white text-xs font-bold">
            Chat
          </button>
