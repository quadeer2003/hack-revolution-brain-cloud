  ...
  const testimonials = [
    {
      ...
      designation: "Working on Canvas component",
      src: "https://images.unsplash.com/photo-1623582854588-d60de57fa33f?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      quote:
      "Anaba Abbas's expertise in backend development and authentication systems ensured a smooth and secure user experience. Her ability to design scalable solutions has been instrumental in our success.",
      name: "Anaba Abbas",
    ...
    {
      quote:
      "Mohammad Abdul Quadeer has revolutionized our processes with his exceptional work on Chrome extensions and backend systems. His solutions are intuitive and efficient, significantly enhancing our team's productivity.",
      name: "Mohammad Abdul Quadeer",
