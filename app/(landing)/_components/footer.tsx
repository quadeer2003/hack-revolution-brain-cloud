    ...
    <footer style={styles.footer}>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.socialIcons}>
          <FaInstagram
            style={styles.icon}
            onMouseEnter={(e: React.MouseEvent<SVGElement>) => (e.currentTarget.style.transform = styles.iconHover.transform!)}
      ...
      <div style={styles.section}>
        ...
        <div
          ...
          onMouseEnter={(e: React.MouseEvent<HTMLDivElement>) => (e.currentTarget.style.boxShadow = styles.inputHover.boxShadow!)}
